...
// @ts-ignore
export const BTC_COINS_LOWER_CASE_ETHEREUM = Object.fromEntries(
  Object.entries(BTC_COINS_ETHEREUM).map((entry) => [
    entry[0],
    entry[1].toLowerCase(),
  ])
);
...
// @ts-ignore
export const ETH_COINS_LOWER_CASE_ETHEREUM = Object.fromEntries(
  Object.entries(ETH_COINS_ETHEREUM).map((entry) => [
    entry[0],
    entry[1].toLowerCase(),
  ])
);
...
// @ts-ignore
export const LINK_COINS_LOWER_CASE_ETHEREUM = Object.fromEntries(
  Object.entries(LINK_COINS_ETHEREUM).map((entry) => [
    entry[0],
    entry[1].toLowerCase(),
  ])
);
...
// @ts-ignore
export const EUR_COINS_LOWER_CASE_ETHEREUM = Object.fromEntries(
  Object.entries(EUR_COINS_ETHEREUM).map((entry) => [
    entry[0],
    entry[1].toLowerCase(),
  ])
);
...
// @ts-ignore
export const USD_COINS_LOWER_CASE_ETHEREUM = Object.fromEntries(
  Object.entries(USD_COINS_ETHEREUM).map((entry) => [
    entry[0],
    entry[1].toLowerCase(),
  ])
);
...
// @ts-ignore
export const DECIMALS_LOWER_CASE_ETHEREUM = Object.fromEntries(
  Object.entries(DECIMALS_ETHEREUM).map((entry) => [
    entry[0].toLowerCase(),
    entry[1],
  ])
);
